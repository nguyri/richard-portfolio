...
let entries = [
    ...
    {key:nanoid(), text:`One application of the mitre sled I've been using a lot lately is making triangular braces. I've started using these braces  more often as they offer a much stronger joint than butt or pockethole with no joinery and only sacrificing a small amount of corner space.`, style: {gridColumn:"span 3"}},
